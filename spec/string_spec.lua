...
describe('String Functions', function()
    ...
    describe('_:endsWith(str, target, [position=str:len()])', function()
    ...
    describe('_:replace(str, pattern, repl, [n])', function()
    ...
    describe('_:split(str, separator, [limit=str:len()])', function()
    ...
    describe('_:trim(str, [pattern=" "])', function()
    ...
    describe('_:trimEnd(str, [pattern=" "])', function()
    ...
    describe('_:trimStart(str, [pattern=" "])', function()
    ...
    describe('_:truncate(str, [options={}])', function()
        ...
        it('correctly truncates `str` with `options.length` and `separator` altered', function()
            assert.are.equals(_:truncate('hi-diddly-ho there, neighborino', {length = 24, separator = ' '}), 'hi-diddly-ho there,...')
            assert.are.equals(_:truncate('hi-diddly-ho there, neighborino', {length = 24, separator = '[%p]'}), 'hi-diddly-ho there...')
        end)
    ...
    describe('_:words(str, [pattern])', function()
        it('converts `str` into table of words', function()
            assert.are.same(_:words('fred, barney, & pebbles'), {'fred', 'barney', 'pebbles'})
            assert.are.same(_:words('fred, barney, & pebbles', "[^,%s]+"), {'fred', 'barney', '&', 'pebbles'})
        end)
    end)
end)